...
class AlurPemesananViewModel: ViewModel() {
    ...
    private val _lokasiList = MutableLiveData<ArrayList<DaftarLokasi>>()
    val lokasiList: LiveData<ArrayList<DaftarLokasi>> = _lokasiList
    ...
    fun setLokasiList(value: ArrayList<DaftarLokasi>) {
        _lokasiList.value = value
    }
